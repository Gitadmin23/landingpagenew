        ...
        showControl && (
          <HStack width='100%' height={'50px'} justifyContent={'space-between'} bg={'#00000054'} position={'absolute'} bottom={'0'} paddingX='10px' zIndex={10}>
            <HStack onClick={handlePlayPause} cursor={'pointer'} justifyContent='center' alignItems={'center'} width={'30px'} height={'30px'} borderRadius={'15px'} bg='white'>
              {!isPlaying && <Play size='20px' variant='Linear' color={primaryColor} />}
              {isPlaying && <Pause size='20px' variant='Linear' color={primaryColor} />}
            </HStack>
            ...
            <HStack>
              <HStack marginRight={'10px'} cursor={'pointer'} justifyContent='center' alignItems={'center'} width={'30px'} height={'30px'} borderRadius={'15px'} bg='white'>
                {isMuted && <VolumeSlash size='20px' variant='Linear' color={primaryColor} onClick={hanldeMute} />}
                {!isMuted && <VolumeHigh size='20px' variant='Linear' color={primaryColor} onClick={hanldeMute} />}
              </HStack>
              <HStack onClick={handlePlayPause} cursor={'pointer'} justifyContent='center' alignItems={'center'} width={'30px'} height={'30px'} borderRadius={'15px'} bg='white'>
                <Maximize2 onClick={handleDoubleClick} size='20px' variant='Linear' color={primaryColor} />
              </HStack>
            </HStack>
          </HStack>
        )
