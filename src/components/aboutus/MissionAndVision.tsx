    ...
    return(
        <Flex w={"full"} px={["6", "6", "12"]} py={["10", "10", "20"]} flexDir={["column", "column", "row"]} gap={"8"} bgColor={"#FCFCFCF5"} >
            <Flex w={"full"} h={[ "auto", "auto", "439px"]} py={"8"} gap={"2"} justifyContent={"center"} shadow={"lg"} rounded={"xl"} px={"8"} flexDir={"column"} >
                ...
                <Text fontSize={["20px", "20px", "45px"]} fontWeight={"600"} lineHeight={["24.2px", "24.2px", "54.46px"]} color={primaryColor} >Our Mission</Text>
            ...
            <Flex w={"full"} h={[ "auto", "auto", "439px"]} py={"8"} gap={"2"} justifyContent={"center"} shadow={"lg"} rounded={"xl"} px={"8"} flexDir={"column"} >
                ...
                <Text fontSize={["20px", "20px", "45px"]} fontWeight={"600"} lineHeight={["24.2px", "24.2px", "54.46px"]} color={primaryColor} >Our Vision</Text>
