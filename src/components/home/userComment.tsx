...
export default function UserComment() {
    ...
    const Video = (props: IProps) => {
        ...
        return (
            <Flex w={["420px", "420px", "512px"]} h={["220px", "220px", "330px"]} bgColor={"white"} justifyContent={"center"} borderWidth={"1px"} borderColor={"#E2E8F0"} rounded={"14px"} alignItems={"center"}  >
    ...
    return (
        <Flex w={"full"} flexDir={"column"} bgColor={"white"} pt={["8", "8", "12"]} pb={["4", "4", "12"]} gap={"9"} >
            ...
            <Flex w={"full"} justifyContent={"end"} gap={"4"} px={"12"} >
                <Flex onClick={() => scroll(-400)} cursor={"pointer"} w={"40px"} h={"40px"} pr={"1"} justifyContent={"center"} alignItems={"center"} rounded={"full"} borderWidth={"1px"} borderColor={"black"} >
                    <IoChevronBack size={"20px"} />
                </Flex>
                <Flex onClick={() => scroll(400)} cursor={"pointer"} w={"40px"} h={"40px"} pl={"1"} justifyContent={"center"} alignItems={"center"} rounded={"full"} borderWidth={"1px"} borderColor={"black"} >
